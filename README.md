...
| File / folder        | Role |
|----------------------|------|
| **app.py**           | Streamlit UI: Home, Disease Search, Symptom Checker, Explanation View, System Info, Manage Diseases, Symptom History. No medical logic in UI. |
...
6. **UI** — Sidebar: Home, Disease Search, Symptom Checker, Explanation View, Manage Diseases, Symptom History, System Info; clear medical terminology.  
...
9. **Ethical & legal** — Read-only, non-diagnostic.  
